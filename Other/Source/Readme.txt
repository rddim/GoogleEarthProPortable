...
user in an INI file next to GoogleEarthProPortable.exe called GoogleEarthProPortable.ini.
...
copy AppNamePortable.ini from this directory to GoogleEarthProPortable.ini next to
GoogleEarthProPortable.exe. The options in the INI file are as follows:
...
The EnableCache entry allows you to set the Cache to \Data\Cache folder if true.
